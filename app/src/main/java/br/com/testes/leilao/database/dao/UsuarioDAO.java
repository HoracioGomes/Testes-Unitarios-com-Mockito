package br.com.testes.leilao.database.dao;
...
import br.com.testes.leilao.database.DatabaseHelper;
import br.com.testes.leilao.database.contrato.UsuarioContrato;
import br.com.testes.leilao.model.Usuario;

import static br.com.testes.leilao.database.contrato.UsuarioContrato.CHAVE_NOME;
import static br.com.testes.leilao.database.contrato.UsuarioContrato.TABELA_NOME;
...
public class UsuarioDAO extends DatabaseHelper {
    ...
    public Usuario salva(Usuario usuario) {
        ...
        return new Usuario(usuario.getNome());
    }
